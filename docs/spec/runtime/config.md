...
| `OPENCOMPANY_INFERENCE_URL` | `{TINYHUMANS_API_URL}/agent-integrations/openrouter` | Harness-brain OpenAI-compatible endpoint (`openhuman` feature); the TinyHumans OpenRouter proxy |
