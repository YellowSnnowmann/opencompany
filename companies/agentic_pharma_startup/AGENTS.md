...
regulator would read. `[policy].mode = "auto"` runs the roster's own sandbox
writes and outward reads unattended and parks everything that leaves the
organization or spends money.
